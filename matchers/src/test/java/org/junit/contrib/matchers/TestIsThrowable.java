...
import org.junit.contrib.matchers.IsThrowable.IBlock;
 ...
 * {@link org.junit.contrib.matchers.IsThrowable} matcher
...
public final class TestIsThrowable {
    ...
    public void throwingDescribedAs() {
        ...
        assertThat(block, describedAs("\n%0 must be thrown due to the original array length is " + array.length + "," +
