...
import static org.junit.contrib.theories.PotentialAssignment.*;

public class PotentialAssignmentTest {
    @Test public void shouldUseQuotedValueInDescription() throws CouldNotGenerateValueException {
    ...
    @Test public void shouldNotUseQuotesForNullValueDescriptions() throws CouldNotGenerateValueException {
    ...
    @Test public void shouldIncludeFailureInDescriptionIfToStringFails() throws CouldNotGenerateValueException {
    ...
    @Test public void shouldReturnGivenValue() throws CouldNotGenerateValueException {
        Object value = new Object();
        PotentialAssignment assignment = PotentialAssignment.forValue("name", value);
